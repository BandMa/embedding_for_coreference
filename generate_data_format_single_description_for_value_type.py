...
name_slot= [ 'hotel-name', 'train-departure', 'train-destination', 'attraction-name', 'restaurant-food', 'restaurant-name', 'taxi-destination', 'taxi-departure', ]
time_form_slot = ['train-arriveby', 'train-leaveat', 'taxi-leaveat', 'taxi-arriveby', 'restaurant-booktime',]
bool_slot = ['hotel-parking', 'hotel-internet', ]
num_form_slot = ['hotel-bookpeople', 'hotel-bookstay', 'hotel-stars', 'restaurant-bookpeople', 'train-bookpeople', ]
category_form_slot = ['hotel-pricerange', 'hotel-type', 'hotel-bookday', 'hotel-area', 'train-day', 'attraction-area', 'attraction-type', 'restaurant-area', 'restaurant-pricerange', 'restaurant-bookday', ]

type_list = {'name': name_slot, 'time': time_form_slot, 'bool': bool_slot, 'num': num_form_slot, 'category': category_form_slot}

slot_name_2_type = {'hotel-name': 'name',
 'train-departure': 'name',
 'train-destination': 'name',
 'attraction-name': 'name',
 'restaurant-food': 'name',
 'restaurant-name': 'name',
 'taxi-destination': 'name',
 'taxi-departure': 'name',
 'train-arriveby': 'time',
 'train-leaveat': 'time',
 'taxi-leaveat': 'time',
 'taxi-arriveby': 'time',
 'restaurant-booktime': 'time',
 'hotel-parking': 'bool',
 'hotel-internet': 'bool',
 'hotel-bookpeople': 'num',
 'hotel-bookstay': 'num',
 'hotel-stars': 'num',
 'restaurant-bookpeople': 'num',
 'train-bookpeople': 'num',
 'hotel-pricerange': 'category',
 'hotel-type': 'category',
 'hotel-bookday': 'category',
 'hotel-area': 'category',
 'train-day': 'category',
 'attraction-area': 'category',
 'attraction-type': 'category',
 'restaurant-area': 'category',
 'restaurant-pricerange': 'category',
 'restaurant-bookday': 'category'}
...
for i in range(len(data_list)):
    ...
    #wait_list = type_list[slot_name_2_type[]]
    
    processed_data.append({'query': query, 'corpus': refer.copy(), 'dialog_seen': data_list[i]['diag_seen_slots']})

path = 'D:\Python4work\paper_modified_test\sv_type_augment_data_t1'
    ...
    with open(hard_save_path, 'w', encoding='utf-8') as file_obj:
        for i in range(len(processed_data)):
            for k,v in processed_data[i]['corpus'].items():
                ...
                type_candidate_slots = type_list[slot_name_2_type[v]]

                diag_seen_slots = diag_seen_slots + type_candidate_slots
